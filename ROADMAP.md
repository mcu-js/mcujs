...
- [x] Waveshare RP2350-Touch-LCD-1.69 (ST7789V2 display 240x280, 16MB flash, touch, IMU, buzzer)
- [x] Waveshare RP2040-PiZero (DVI/HDMI output, 16MB flash)
- [x] Adafruit Feather RP2040 (NeoPixel, STEMMA QT, 8MB flash)
- [ ] Raspberry Pi Pico W (CYW43 WiFi/BLE chip)
- [ ] Additional Waveshare RP2040/RP2350 boards
