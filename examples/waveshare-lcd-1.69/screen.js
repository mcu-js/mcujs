...
function createScreen(options) {
  ...
  // Default to portrait orientation (240x280) - natural for this display
  var horizontal = options.horizontal !== undefined ? options.horizontal : false;
  var width = options.width || (horizontal ? 280 : 240);
  var height = options.height || (horizontal ? 240 : 280);
  ...
  // Window offsets for ST7789V2
  // Display RAM is 240x320, screen is 240x280
  // Center 280 rows in 320-row RAM: (320-280)/2 = 20
  var colOffset = horizontal ? 20 : 0;
  var rowOffset = horizontal ? 0 : 20;
  ...
  function init() {
    ...
    if (horizontal) {
      ...
      dat(0x00);  // Vertical mode (portrait)
    }
